...
const envSchema = z.object({
  ...
  SBI_MID: z.string().optional().default('1000112'),
  SBI_KEY: z.string().optional().default('A7C9F96EEE0602A61F184F4F1B92F0566B9E61D98059729EAD3229F882E81C3A'),
  SBI_URL: z.string().optional().default('https://test.epay.sbiuat.bank.in/secure/AggregatorHostedListener'),
  SBI_REQUERY_URL: z.string().optional().default('https://test.epay.sbiuat.bank.in/payagg/statusQuery/getStatusQuery'),
  SBI_RETURN_URL: z.string().optional().default('https://e3llr43lb5.execute-api.ap-south-1.amazonaws.com/api/v1/payment/gateway/return'),
